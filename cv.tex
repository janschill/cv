...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://linkedin.com/in/jan-schill/}{linkedin.com/in/jan-schill} & Mobile : +45-27620100 \\
  \href{https://github.com/janschill}{github.com/janschill}
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \begin{tabular*}{0.97\textwidth}{l@{\extracolsep{\fill}}r}
    \vspace{-5pt}
      \textit{\small Software Engineer II} & \textit{\small Aug. 2021--Mar. 2023} \\
    \end{tabular*}\vspace{-5pt}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{CERN-Solid Code Investigation}
          {Exposure to the code of popular, complex, well-designed and documented applications of today and tomorrow. Work with interesting technical challenges and expert software developers. Gain in organizational expertise.}
      \resumeItemListEnd
